...
/**
 * The MIDI file manager: drag-and-drop upload, searchable list, download,
 * delete, and "edit instruments". Owns all its own UI state; talks to the
 * editor only through `select` (a file to use) and `edit-instruments`.
 */
const props = defineProps<{ open: boolean; currentId: number | null }>();
